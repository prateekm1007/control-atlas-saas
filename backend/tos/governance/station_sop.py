...
STATION_METADATA = {
    "version": "22.4.2",
    "institution": "TOSCANINI Universal Governance",
    "posture": "PHYSICS_CONSERVATIVE",
...
LAW_CANON = {
    ...
    "LAW-105": {"title": "Reliability Coverage", "principle": "Core >= 30% and 40+ res.", "threshold": 30.0, "unit": "%", "severity": "FATAL"},
    ...
    "LAW-125": {"title": "Ramachandran", "principle": "Phi/Psi outliers < 5%.", "threshold": 5.0, "unit": "%", "severity": "FATAL"},
    "LAW-130": {"title": "Steric Clash", "principle": "Rejects overlaps > 5.0 score.", "threshold": 5.0, "unit": "score", "severity": "FATAL"},
    "LAW-135": {"title": "Omega Planarity", "principle": "Peptide planarity < 3%.", "threshold": 3.0, "unit": "%", "severity": "FATAL"},
...
# 2. THE PHYSICS TABLES (Engh-Huber Benchmarks)
# Required by tier1_measurements.py
SIGMA_TABLE = {
    "N-CA": 0.010, "CA-C": 0.021, "C-O": 0.020, "C-N": 0.014, 
    "CA-CB": 0.020, "C-S": 0.025, "S-S": 0.016,
    "N-CA-C": 2.5, "CA-C-N": 1.5, "O-C-N": 1.6
}

IDEAL_TABLE = {
    "N-CA": 1.470, "CA-C": 1.525, "C-O": 1.231, "C-N": 1.329, 
    "CA-CB": 1.530, "C-S": 1.803, "S-S": 2.033,
    "N-CA-C": 111.0, "CA-C-N": 116.6, "O-C-N": 123.0
}

# 3. METHOD CLASSIFICATIONS
LAW_METHOD_CLASSIFICATIONS = {lid: "deterministic" if lid not in ["LAW-155", "LAW-182", "LAW-200"] else "heuristic" for lid in LAW_CANON}

# 4. COMPUTED LISTS & COUNTS (Requirement for main.py)
...
# 5. CATEGORIES (Requirement for pdf_generator.py)
...
# 6. SCORE DEFINITIONS
SCORE_DEFINITIONS = {
    "DETERMINISTIC_SCORE": {"title": "Deterministic Integrity", "explanation": "VETO gate. Requires 100% adherence to physical invariants.", "impact": "Authoritative."},
    "ADVISORY_SCORE": {"title": "Heuristic Advisory", "explanation": "Approximate metrics for prioritization.", "impact": "Advisory."},
    "ML_CONFIDENCE": {"title": "ML Confidence", "explanation": "pLDDT confidence.", "impact": "Epistemic."},
    "STRATEGIC_SCORE": {"title": "EPI Priority Index", "explanation": "Success probability score.", "impact": "Strategic."}
}

# 7. PIPELINE CONSTANTS
...
CONFIDENCE_EXCLUSION_POLICY = {"trigger": "mean_confidence <= 0", "action": "exclude", "disclosure": "Excluded"}
