...
# --- CATEGORY METADATA (required by pdf_generator.py) ---
LAW_CATEGORIES = {
    "LAW-100": "geometric", "LAW-105": "geometric", "LAW-110": "geometric",
    "LAW-120": "geometric", "LAW-125": "geometric", "LAW-130": "geometric",
    "LAW-135": "geometric", "LAW-145": "chemical", "LAW-150": "chemical",
    "LAW-155": "geometric", "LAW-160": "geometric", "LAW-170": "chemical",
    "LAW-182": "chemical", "LAW-195": "chemical", "LAW-200": "geometric",
}
CATEGORY_DISPLAY = {
    "geometric": "GEOMETRIC INTEGRITY",
    "chemical": "CHEMICAL INTEGRITY",
}

def get_laws_by_category():
    groups = {}
    for lid, cat in LAW_CATEGORIES.items():
        groups.setdefault(cat, []).append(lid)
    for cat in groups:
        groups[cat].sort()
    return groups
